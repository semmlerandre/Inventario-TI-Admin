...
const MOVEMENT_TYPES = [
  ...
  { value: "devolucao_fornecedor", label: "Devolução ao Fornecedor", needsUser: false },
...
const MOVEMENT_TYPE_COLORS: Record<string, string> = {
  ...
  devolucao_fornecedor: "bg-purple-50 text-purple-700 border-purple-200",
...
const STATUS_CONFIG: Record<string, { label: string; class: string }> = {
  ...
  devolvido_fornecedor: { label: "Devolvido ao Fornecedor", class: "bg-purple-50 text-purple-700 border-purple-200" },
...
function ExtraFields({ control, setValue }: {
  ...
  return (
    <>
      ...
      {/* Campos exclusivos de Hardware — alimentam o Histórico */}
      {isHardware && (
        <>
          <div className="p-3 bg-blue-50 border border-blue-100 rounded-lg text-xs text-blue-700 flex items-start gap-2">
            ...
            <span>Os campos abaixo alimentam automaticamente o <strong>Histórico</strong>.</span>
          </div>
...
export default function InventoryPage() {
  ...
  const returnedSupplier = hardwareItems.filter((i) => i.eqStatus === "devolvido_fornecedor").length;
  ...
  const today = new Date().toISOString().substring(0, 10);
    const ITEM_HEADERS = ["Nome", "Categoria", "Tipo", "Hostname", "Modelo", "Fabricante", "N° Série", "Fornecedor", "Propriedade", "Status", "Responsável", "Departamento"];
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-display font-bold text-slate-900">Ativos TI</h1>
        ...
        <Tabs defaultValue="estoque">
          <TabsList className="bg-slate-100 p-1 rounded-xl">
            ...
            <TabsTrigger value="rastreio" className="rounded-lg" data-testid="tab-rastreio">
              <ScanLine className="w-4 h-4 mr-2" /> Histórico
            ...
            <Card className="border-none shadow-md shadow-slate-200/50">
              <div className="p-4 border-b border-slate-100 flex items-center justify-between gap-3">
                ...
                <div className="flex gap-2 no-print">
                  ...
                  <Button variant="outline" size="sm" onClick={() => printWithBranding("Relatório de Ativos TI")} className="hidden md:flex">
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end" className="w-48">
                                ...
                                <DropdownMenuItem onClick={() => openTransaction(item, "in")} className="text-emerald-600 font-medium cursor-pointer">
                                  <ArrowDownToLine className="mr-2 h-4 w-4" /> Registrar Movimentação
                                </DropdownMenuItem>
              ...
              <Card className="border-none shadow-md shadow-slate-200/50">
                <div className="text-center py-16 px-8">
                  ...
                  <p className="text-slate-400 text-sm mt-2 max-w-md mx-auto">
                    Vá para a aba <strong>Equipamentos</strong>, clique em <strong>Novo Item</strong> e selecione a categoria <strong>Hardware</strong>. Os equipamentos aparecerão aqui automaticamente.
                  </p>
              ...
              <>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {[
                    ...
                    { label: "Devolvido ao Fornecedor", value: returnedSupplier, icon: Package, color: "text-purple-700", bg: "bg-purple-50 border-purple-200" },
                ...
                <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                  ...
                  <Select value={eqStatusFilter} onValueChange={setEqStatusFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="devolvido_fornecedor">Devolvido ao Fornecedor</SelectItem>
                      <SelectItem value="descartado">Descartado</SelectItem>
                    </SelectContent>
                  </Select>
                  <div className="flex gap-2 ml-auto no-print">
                    <Button variant="outline" size="sm" onClick={() => downloadBrandedCSV("Histórico", EQ_HEADERS, eqRows(), `rastreio-${today}.csv`)}>
                      <Download className="w-4 h-4 mr-2" /> CSV
                    </Button>
                    <Button variant="outline" size="sm" onClick={() => downloadBrandedXLSX("Histórico", EQ_HEADERS, eqRows(), `rastreio-${today}.xlsx`, "Rastreio")} className="border-green-300 text-green-700 hover:bg-green-50">
                      <FileSpreadsheet className="w-4 h-4 mr-2" /> XLS
                    </Button>
                  </div>
                </div>
